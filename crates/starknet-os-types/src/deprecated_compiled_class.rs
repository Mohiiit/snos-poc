...
mod tests {
    ...
    const DEPRECATED_CLASS: &[u8] =
        include_bytes!("../../../resources/test_contract_compiled.json");
    ...
    fn test_conversion_to_blockifier_class() {
        ...
        let blockifier_class_from_generic_serialized = generic_contract_class_from_serialized
            .to_blockifier_contract_class()
            .unwrap();
        let blockifier_class_from_generic_starknet_core = generic_contract_class_from_starknet_core
            .to_blockifier_contract_class()
            .unwrap();
        let blockifier_class_from_generic_blockifier = generic_contract_class_from_blockifier
            .to_blockifier_contract_class()
            .unwrap();

        assert_eq!(
            blockifier_class_from_generic_serialized,
            expected_blockifier_contract_class
        );
        assert_eq!(
            blockifier_class_from_generic_starknet_core,
            expected_blockifier_contract_class
        );
        assert_eq!(
            blockifier_class_from_generic_blockifier,
            expected_blockifier_contract_class
        );
    }
}
